    ...
    return (
        <>
            <div className="comic">
                ...
                <div className='subtitle classSubtitle'>從選題到轉譯　打造故事力 ——以CCC創作集經驗為例</div>
                <div className='content classSubtitle'>
                IP能否成功，引起閱聽眾共鳴是重要關鍵第一步。前置作業中資料收集影響著「故事力」的底藴，素材該如何轉譯為有魅力的故事呢？要成就一個膾炙人口的IP，從IP本身經營到外力整合都相當重要，而能否跨域發揚光大至成就IP宇宙，最關鍵當然是IP的故事力，扎實的內容才有無限延伸的空間，而前期醖釀深深影響著IP本質的好壞。
            ...
            <div className="film">
                ...
                <div className='subtitle classSubtitle'>韓國人來吿訴你《我的少女時代》在韓國為什麽紅</div>
                <div className='content classSubtitle'>
                文策院今（2022）年委託Ipsos韓國團隊透過爬梳當地資料與數據，剖析臺灣電影《我的少女時代》能在韓國創下首映近41萬觀影人次，並獲得韓國2016年外國藝術／獨立電影票房第二名，背後的成功因素究竟為何，同時提出未來臺灣電影要進入韓國市場可能面臨的挑戰、機會點，以及可嘗試的行銷方式。但在此前，我們得先了解韓國近二年的電影產業狀況及市場偏好，才會更淸楚臺灣電影能夠進入韓國並取得票房成功之不易。
            ...
            <div className="interdisciplinary">
                ...
                <div className='subtitle classSubtitle'>線上展演來臨，要注意的是......</div>
                <div className='content classSubtitle'>
            ...
            <div className="game">
                ...
                <div className='subtitle classSubtitle'>德e製，前進！德國策進遊戲內容開發面面觀</div>
                <div className='content classSubtitle'>
