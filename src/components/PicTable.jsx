...
const PicTable = () => {
    ...
    return (
        <>
            <div className='picTableCard' id="02section_INTERDISCIPLINARY">
                <div className='content classBetween'>INTERDISCIPLINARITY</div>
                <div className='subContent classBetween'>探查網路高活躍的年輕族群閱讀傾向</div>
                ...
                <div className='pink classSubtitle'><a href="./02_interdisciplinary.html">MORE＋</a></div>
            ...
            <div className='picTableCard' id="02section_TV">
                <div className='content classBetween'>TV</div>
                <div className='subContent classBetween'>疫情下臺劇網路聲量追追追</div>
                <div className='content classSubtitle'>
                ...
                <div className='purple classSubtitle' ><a href="./02_tv.html">MORE＋</a></div>
